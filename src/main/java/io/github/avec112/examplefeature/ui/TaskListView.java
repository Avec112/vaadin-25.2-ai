package io.github.avec112.examplefeature.ui;

import io.github.avec112.base.ui.ViewTitle;
import io.github.avec112.examplefeature.Task;
import io.github.avec112.examplefeature.TaskService;
...
@Route(value = "task-list")
@PageTitle("Task List")
@Menu(order = 1, icon = "icons/clipboard-check.svg", title = "Task List")
